...
<script>
// import * as Cesium from 'cesium/Cesium' // eslint-disable-line
// const Cesium = require('cesium/Cesium') // eslint-disable-line
// import * as CesiumHeatmap from '../../../plugin/cesium/cesiumHeatmap.js'
let viewer = null
export default {
  name: 'Index',
  data() {
  ...
  methods: {
    ...
    addHeatmap() {
      // new CesiumHeatmap(viewer, '/json/busstop2016.geojson')
    }
  }
}
</script>
